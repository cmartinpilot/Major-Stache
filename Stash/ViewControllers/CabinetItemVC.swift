...
class CabinetItemVC: UIViewController {
    ...
    fileprivate lazy var fetchedResultsController: NSFetchedResultsController<CabinetItem>? = {
        ...
        var controller:NSFetchedResultsController<CabinetItem>? = (self.dataManager?.fetchedResultsController(type: .cabinetItem, sortDescriptors: [sortDescriptors], predicate: predicate, delegate: self))
